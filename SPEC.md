...
| カテゴリ | 検出キーワード（例） |
|---------|-------------------|
| WORK | 副業、作業、開発、プログラミング、コーディング、ライティング、ブログ |
| EXERCISE | 運動、筋トレ、ジム、散歩、ランニング、ヨガ、スクワット |
...
入力した行動の **カテゴリ** と **時間** がクエスト条件を満たした瞬間に自動達成。追加EXPは即時付与。
