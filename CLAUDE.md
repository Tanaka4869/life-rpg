...
| v2.3.4 | Quick Actionに腕立て・スクワット・腹筋を追加・アクションショートカットから「筋トレ」を削除 |
| v2.3.5 | ボス攻撃力を日次ランダム選択ステータスの当日上昇量ベースに変更（todayBattleStat / todayStatGains） |
| v2.3.6 | Quick Actionに「瞑想」を追加 |
